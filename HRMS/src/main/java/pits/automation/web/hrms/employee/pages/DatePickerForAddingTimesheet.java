...
public class DatePickerForAddingTimesheet extends AbstractUIObject {
	...
	@FindBy(xpath = "//div[4]/div/div/div/div[1]/button[1]")
	private List<ExtendedWebElement> backwardButton;

	@FindBy(xpath = "//div[4]/div/div/div/div[1]/button[2]")
	private List<ExtendedWebElement> forwardButton;

	@FindBy(xpath = "//div[4]/div/div/div/div[1]/button[2]")
	private List<ExtendedWebElement> datePickerBox;

	public DatePickerForAddingTimesheet(WebDriver driver, SearchContext searchContext) {
